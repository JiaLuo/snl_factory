...
public class OrderDetailAdapter extends BaseAdapterNew<OrderDetailEntity.OrderDetailItem> {
    ...
    public OrderDetailAdapter(Context context, List<OrderDetailEntity.OrderDetailItem> mDatas) {
    ...
    protected void setViewData(View convertView, final int ListviewPosition) {
        OrderDetailEntity.OrderDetailItem item = getItem(ListviewPosition);
        ...
        if (item != null){
            ...
            if(item.getImgs() != null && item.getImgs().size() > 0){
                ...
                OrderDetailGridAdapter orderDetailGridAdapter = new OrderDetailGridAdapter(context,item.getImgs());
