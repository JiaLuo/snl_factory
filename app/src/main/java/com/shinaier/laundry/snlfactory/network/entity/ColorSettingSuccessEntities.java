...
public class ColorSettingSuccessEntities {
    @SerializedName("data")
    private SettingSuccessData datas;
    @SerializedName("retcode")
    private int retcode;
    @SerializedName("status")
    private String status;

    public SettingSuccessData getDatas() {
        return datas;
    }

    public void setDatas(SettingSuccessData datas) {
        this.datas = datas;
    }
    ...
    public static class SettingSuccessData implements Parcelable {
        ...
        protected SettingSuccessData(Parcel in) {
            color = in.readString();
        ...
        public static final Creator<SettingSuccessData> CREATOR = new Creator<SettingSuccessData>() {
            @Override
            public SettingSuccessData createFromParcel(Parcel in) {
                return new SettingSuccessData(in);
            }

            @Override
            public SettingSuccessData[] newArray(int size) {
                return new SettingSuccessData[size];
            }
        };
