...
import com.shinaier.laundry.snlfactory.ordermanage.adapter.OrderManagePagerAdapter;
...
public class OrderManageFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        orderManageType.setScrollBar(colorBar);
        orderManageType.setSplitAuto(true);
        orderManageType.setOnTransitionListener(new OnTransitionTextListener().setColor(ContextCompat.getColor(context,
                R.color.base_color), ContextCompat.getColor(context, R.color.black_text)));

        IndicatorViewPager indicatorViewPager = new IndicatorViewPager(orderManageType, vpOrderManage);
        ...
        OrderManagePagerAdapter memberCardPagerAdapter = new OrderManagePagerAdapter(getChildFragmentManager(),context,orderManageWillDisposeFragment,
                orderManageWillTakeOrderFragment,orderManageWillCleanFragment,orderManageWillCleaningFragment,orderManageWillSendFragment);
        indicatorViewPager.setAdapter(memberCardPagerAdapter);
