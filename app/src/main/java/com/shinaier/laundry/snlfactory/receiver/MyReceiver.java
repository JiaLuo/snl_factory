...
////		LogUtil.e("zhang","EXTRA_ALERT = " + bundle.get(JPushInterface.EXTRA_ALERT));
////		LogUtil.e("zhang","EXTRA_MESSAGE = " + bundle.get(JPushInterface.EXTRA_MESSAGE));
////		LogUtil.e("zhang","EXTRA_EXTRA = " + bundle.get(JPushInterface.EXTRA_EXTRA));
////		LogUtil.e("zhang","EXTRA_TITLE = " + bundle.get(JPushInterface.EXTRA_TITLE));
...
//					if("new_orders.mp3".equals(sound)){
